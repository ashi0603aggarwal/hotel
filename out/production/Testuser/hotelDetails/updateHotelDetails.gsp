                    ...
                    <g:form action="updateDetails">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <input name="hotelLicenceNo" title="hotelLicenceNo" id="hotelLicenceNo" type="text" class="form-control" value="${hotelDetails.hotelLicenceNo}">
                                    </div>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <input name="foodLicenceNo" title="foodLicenceNo" id="foodLicenceNo" type="text" class="form-control" value="${hotelDetails.foodLicenceNo}">
                                    </div>
                                </div>
                                 <div class="input-group">
                                    <span class="input-group-addon">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <input name="billSeries" title="billSeries" type="text" id="billSeries" class="form-control" value="${hotelDetails.billSeries}">
                                    </div>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <input name="phoneNo" title="phoneNo" type="text" id="phoneNo" class="form-control" value="${hotelDetails.mobileNo}">
                                    </div>
                                </div>
                                <div class="input-group">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Hotel Rooms</label>
                                        <input type="file" name="hotelRoomsFile" id="hotelRoomsFile" value="${hotelDetails.hotelRooms}"/>
                        ...
                        <div class="wizard-footer">
                            <div class="pull-right">
                                <g:actionSubmit class="btn btn-success btn-wd" value="Update" action="updateDetails"/>
                            </div>
                        </div>
                    </g:form>
                </div>
