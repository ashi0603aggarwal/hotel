...
<tr>
    <td><a class="cut">-</a><span >${roomNo}</span></td>
    <td><span data-prefix>Rs.</span><span><g:textField name="roomRate" title="roomRate"  onChange="updateInvoice()"/></span></td>
    <td><span><g:textField name="noOfPerson"></g:textField></span></td>
